                    ...
                    <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
						...
						<div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text"
                                   name="surname"
                                   id="surname" value="{{ old('surname', '') }}" required>
						...
						<div class="form-group">
                            ...
                            <input class="form-control date {{ $errors->has('associate_due') ? 'is-invalid' : '' }}"
                                   type="text"
                                   name="associate_due" id="associate_due" value="{{ old('associate_due') }}">
						...
						<div class="form-group">
                            ...
                            <input class="form-control date {{ $errors->has('advanced_due') ? 'is-invalid' : '' }}"
                                   type="text"
                                   name="advanced_due" id="advanced_due" value="{{ old('advanced_due') }}">
						...
						<div class="form-group">
							...
							<textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" rows="10" cols="50" name="notes"

    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("app.activities.store") }}" enctype="multipart/form-data">
				...
				<div class="form-group">
                    <div class="form-check form-check-inline icheck-primary {{ $errors->has('paid') ? 'is-invalid' : '' }}">
                        <input type="hidden" name="paid" value="0">
                        <input class="form-check-input" type="checkbox" name="paid" id="paid"
                               value="1" {{ old('paid', 0) == 1 ? 'checked' : '' }}>
						<label class="form-check-label" for="paid"><strong>{{ trans('cruds.activity.fields.paid') }}</strong></label>
                    </div>
                    @if($errors->has('paid'))
				...
				<div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('counter_stop') ? 'is-invalid' : '' }}" type="number"
                           name="counter_stop" id="counter_stop" value="{{ old('counter_stop', '0') }}" step="1"
                           required>
                    @if($errors->has('counter_stop'))
                        <span class="text-danger">{{ $errors->first('counter_stop') }}</span>
                    @endif
